...
export default defineConfig({
  ...
  // Capped locally too. The default, half the cores, starts up to ten browsers
  // against the one preview server, and the axe scans in a11y.e2e.ts then
  // starve and time out waiting to render. Four is also no slower here.
